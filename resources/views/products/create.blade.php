...
<head>
    ...
    <title>Добавление товара - COMICWERS</title>
        ...
        <div class="form-container">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="product-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name_product" name="name_product" value="{{ old('name_product') }}" class="form-control" required>
                    @error('name_product')
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price') }}" step="0.01" min="0" class="form-control" required>
                    @error('price')
                    <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('products.index') }}" class="btn-secondary">Отмена</a>
                </div>
            </form>
        </div>
    </main>
